...
records = records.map(r => {
    return {
        ...
        COMP: (r['Membership Type'].includes('Non') ? '0':'1')
    }
})
...
let o ="NAME,C,35	INITIALS,C,4	CODE,C,7	CLUBCODE,C,30	CLUB,C,1	YEAR,C,1	PROV,C,1	MR_MRS,C,5	R_SEX,C,1	LANGUAGE,C,1	TELEPHONE,C,12	TELCODE,C,1	ADDRESS_1,C,22	ADDRESS_2,C,22	ADDRESS_3,C,22	CALLNAME,C,25	NCODE,C,30	B_DATE,C,11	OLDCODE,C,30	EMAIL,C,30	SEN_JUN,C,10	COMP,C,1"
