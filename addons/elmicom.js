...
function AddMeter(req, response) {
    ...
    if(req.body && (req.body.eth == 'down' || req.body.eth == 'up')) {
        ...
        sendPush(new ObjectID('5e34f845b883f109838a5af6'),req.params.meterId, 'Ethernet', req.body.eth);
    }
    if(req.body && (req.body.status == 'down' || req.body.status == 'up')) {
        ...
        sendPush(new ObjectID('5e34f845b883f109838a5af6'),req.params.meterId, 'Status', req.body.status);
    }
